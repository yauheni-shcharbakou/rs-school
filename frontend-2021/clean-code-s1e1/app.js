...
var taskInput=document.querySelector("#add-task");//Add a new task.
var addButton=document.querySelector(".btn");//first button
var incompleteTaskHolder=document.querySelector("#uncompleted-tasks-list");//ul of #incomplete-tasks
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.classList.add('task', 'input', 'task-list__input');
